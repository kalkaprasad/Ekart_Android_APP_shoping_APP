package redtech.ekart.shop.activity;
...
import redtech.ekart.shop.helper.Constant;
...
//
    ...
    public void OnBtnClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tvPlaceOrder:
                ...
                break;
            case R.id.imgedit:
                startActivity(new Intent(CheckoutActivity.this, wrteam.ekart.shop.activity.ProfileActivity.class));
                break;
            case R.id.tvUpdate:
                if (ApiConfig.isGPSEnable(CheckoutActivity.this))
                    startActivity(new Intent(CheckoutActivity.this, wrteam.ekart.shop.activity.MapActivity.class));
                else
                                ...
                                try {
                                    ...
                                    if (!object.getBoolean(Constant.ERROR)) {
                                        if (chWallet.getTag().toString().equals("true"))
                                            ApiConfig.getWalletBalance(CheckoutActivity.this, session);
                                        dialog.dismiss();
                                        startActivity(new Intent(CheckoutActivity.this, wrteam.ekart.shop.activity.OrderPlacedActivity.class));
                                        finish();
                                    } else {
                    ...
                    if (result) {
                        try {
                            ...
                            if (!object.getBoolean(Constant.ERROR)) {
                                ...
                                startActivity(new Intent(CheckoutActivity.this, wrteam.ekart.shop.activity.OrderPlacedActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK));
                                finish();
    ...
    public void StartPayPalPayment(final Map<String, String> sendParams) {
        ...
        ApiConfig.RequestToVolley(new VolleyCallback() {
            ...
            public void onSuccess(boolean result, String response) {
                hideProgressDialog();
                Intent intent = new Intent(getApplicationContext(), wrteam.ekart.shop.activity.PayPalWebActivity.class);
                ...
                if (result) {
                    try {
                        ...
                        if (!object.getBoolean(Constant.ERROR)) {
                            ...
                            wrteam.ekart.shop.activity.DrawerActivity.tvWallet.setText(getString(R.string.wallet_balance) + "\t:\t" + Constant.SETTING_CURRENCY_SYMBOL + Constant.WALLET_BALANCE);
                            tvWltBalance.setText(getString(R.string.total_balance) + Constant.SETTING_CURRENCY_SYMBOL + Constant.WALLET_BALANCE);
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
